  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <div style={{
        ...
        border: `1.5px solid ${error ? "rgba(239, 68, 68, 0.4)" : COLORS.inputBorder}`,
  ...
  return (
    <button
      ...
      style={{
        ...
        border: isPrimary ? "none" : `1.5px solid ${COLORS.primaryBorder}`,
        background: isPrimary ? `linear-gradient(135deg, ${COLORS.primaryDark} 0%, ${COLORS.accent} 100%)` : "transparent",
...
const Logo = () => (
  <div style={{ textAlign: "center", marginBottom: 8 }}>
    ...
    <h1 style={{ fontSize: 28, fontWeight: 800, color: COLORS.text, margin: 0 }}>
      <span style={{ color: "#e2e8f0" }}>Re</span>
      <span style={{ color: "#38bdf8" }}>Bu</span>
    </h1>
    <p style={{ color: COLORS.textDim, fontSize: 14, margin: "4px 0 0" }}>Your neighborhood job marketplace</p>
  </div>
);
...
const Divider = () => (
  <div style={{ display: "flex", alignItems: "center", margin: "20px 0", gap: 12 }}>
    ...
    <span style={{ fontSize: 12, color: COLORS.textDim, fontWeight: 600 }}>OR</span>
    <div style={{ flex: 1, height: 1, background: COLORS.border }} />
  </div>
);
...
const Toast = ({ message, type = "success" }) => (
  <div style={{
    ...
    background: type === "success" ? COLORS.success : COLORS.error, color: "#fff",
    padding: "12px 28px", borderRadius: 10, fontWeight: 600, fontSize: 14,
    boxShadow: "0 8px 30px rgba(0,0,0,.4)", zIndex: 999, animation: "slideDown .3s ease",
    fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
  }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {["login", "signup"].map(v => (
            <button key={v} onClick={() => { setView(v); setLErrors({}); setSErrors({}); }} style={{
              ...
              background: view === v ? COLORS.primaryGlow : "transparent",
              color: view === v ? COLORS.primary : COLORS.textDim,
              fontWeight: 700, fontSize: 14, cursor: "pointer", transition: "all .2s",
              fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
            }}>
        ...
        {view === "login" ? (
          <>
            ...
            <p style={{ textAlign: "center", fontSize: 13, color: COLORS.textDim, marginTop: 16 }}>
              Demo: <strong style={{ color: COLORS.textMuted }}>demo@rebu.com</strong> / <strong style={{ color: COLORS.textMuted }}>password123</strong>
            </p>
          </>
        ) : (
          <>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: COLORS.textDim, marginBottom: 8 }}>I want to...</label>
